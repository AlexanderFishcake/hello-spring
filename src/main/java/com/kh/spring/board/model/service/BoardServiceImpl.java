...
public class BoardServiceImpl implements BoardService {
	...
	/**
	 * rollbackFor - 트랜잭션 rollback처리하기 위한 예외 등록. 
	 * Exception -> 모든 예외. 기본값은 RuntimeException만 rollback한다.
	 */
	...
	@Override
	public BoardExt selectBoard(int no) {
		BoardExt board = boardDao.selectBoard(no);
