...
<%
	String[] hobbyArr = ((Member)session.getAttribute("loginMember")).getHobby();
...
<div id="update-container">
	<form name="memberUpdateFrm" action="${pageContext.request.contextPath}/member/memberUpdate.do" method="post">
		...
		<input type="date" class="form-control" placeholder="생일" name="birthday" value="${loginMember.birthday }"  id="birthday"/>
